...
iOS
- - - - -
Скачать файл с расширением mobileconfig на iOS и сохранить в приложение файлы и запустить через это же приложение. Далее
в приложении Настройки (Профиль загружен) нужно разрешить новые сертификаты и установить его. После установки в
настройках появится раздел VPN.
